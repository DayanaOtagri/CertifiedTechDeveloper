package poo.clase3.sincronico;

import java.util.Scanner;

public class EjercicioPiedraPapelTijeraSpock {

    public static String pedirNombreJugador() {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Ingresá el nombre de le jugadore:");
        return scanner.nextLine();
    }

    public static int pedirOpcionJugador(String jugador) {
        Scanner scanner = new Scanner(System.in);
        System.out.println(jugador + " ingresá la opción deseada:\n\t1. Piedra\n\t2. Papel\n\t3. Tijera\n\t4. Spock");
        return validarOpcion(scanner.nextInt(), 1, 4);
    }

    public static int validarOpcion(int numero, int minimo, int maximo) {
        Scanner scanner = new Scanner(System.in);
        while (numero < minimo || numero > maximo) {
            System.out.println("La opción ingresada no es válida, por favor reingresá:\n\t1. Piedra\n\t2. Papel\n\t3. Tijera\n\t4. Spock");
    ...
    public static int calcularGanador(int opcionJ1, int opcionJ2) {
        ...
        if (opcionJ1 != opcionJ2) {
            ...
            if (opcionJ1 == 1 && opcionJ2 == 3 || // J1: piedra, J2: tijera
                ...
                opcionJ1 == 4 && opcionJ2 == 1 || // J1: spock,  J2: piedra
                opcionJ1 == 4 && opcionJ2 == 3) { // J1: spock,  J2: tijera
                ganador = 1;
            } else {
                ganador = 2;
            }
